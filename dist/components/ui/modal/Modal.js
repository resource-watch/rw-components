...
var Modal = function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function getContent() {
      return this.props.options.children ? _react2.default.createElement(this.props.options.children, this.props.options.childrenProps) : null;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(node) {
            _this3.el = node;
          }, className: 'c-modal ' + (this.props.open ? '' : '-hidden') + ' ' + (this.props.options.size || '') },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.props.loading ? _react2.default.createElement(_Spinner2.default, { isLoading: true }) : this.getContent()
          )
        ),
