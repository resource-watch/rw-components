...
var Paginator = function (_React$Component) {
  ...
  function Paginator(props) {
    ...
    // BINDINGS
    _this.triggerChangePage = _this.triggerChangePage.bind(_this);
    return _this;
  }
  ...
  _createClass(Paginator, [{
    ...
    */
    ...
    key: 'triggerChangePage',
    value: function triggerChangePage(page) {
      var _this2 = this;

      this.setState({
        page: page
      }, function () {
        if (_this2.props.onChange) _this2.props.onChange(_this2.state.page);
      });
    }
  }, {
    key: 'render',
