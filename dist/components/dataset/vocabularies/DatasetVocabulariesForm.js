...
var _VocabularyItem = require('../../vocabularies/form/VocabularyItem');
...
var DatasetVocabulariesForm = (_class = function (_React$Component) {
  _inherits(DatasetVocabulariesForm, _React$Component);

  function DatasetVocabulariesForm(props) {
    _classCallCheck(this, DatasetVocabulariesForm);

    var _this = _possibleConstructorReturn(this, (DatasetVocabulariesForm.__proto__ || Object.getPrototypeOf(DatasetVocabulariesForm)).call(this, props));
  ...
  */
  ...
  _createClass(DatasetVocabulariesForm, [{
  ...
  return DatasetVocabulariesForm;
...
exports.default = DatasetVocabulariesForm;